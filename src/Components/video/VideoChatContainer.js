...
import './App.css'
import { createOffer, initiateConnection, startCall, sendAnswer, addCandidate, initiateLocalStream, listenToConnectionEvents } from '../webrc/RTCModule'
import firebase from 'firebase/app'
import 'firebase/database'
import config from '../../src/config'
import { doOffer, doAnswer, doLogin, doCandidate } from '../webrc/FirebaseModule'
